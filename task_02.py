# 2. Напишите функцию, которая получает на вход директорию и рекурсивно обходит её и все
...
def walker_directory(file: Path) -> None:
    ...
    with open(r'C:\Users\admin\Documents\GeekBrains\II год обучения Data Engineer\Основы Python\seminar_08\result.json',
              'w') as json_file:
        json.dump(result, json_file, ensure_ascii=False)

    with open(r'C:\Users\admin\Documents\GeekBrains\II год обучения Data Engineer\Основы Python\seminar_08\result.csv',
    ...
    with open(r'C:\Users\admin\Documents\GeekBrains\II год обучения Data Engineer\Основы Python\seminar_08\result.pickle',
              'wb') as pickle_file:
